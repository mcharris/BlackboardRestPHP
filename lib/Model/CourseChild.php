 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class CourseChild implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CourseChild';
    ...
    /**
     * Sets id
     * @param string $id The primary ID of the child course associated with this cross-listing.
     * @return $this
     */
    ...
    /**
     * Sets data_source_id
     * @param string $data_source_id The ID of the data source associated with this course cross-listing.  This may optionally be the data source's externalId using the syntax \"externalId:math101\".
     * @return $this
     */
    ...
    /**
     * Sets created
     * @param \DateTime $created The date this course cross-listing was created.
     * @return $this
     */
