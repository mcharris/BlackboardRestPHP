...
/**
 * Availability3 Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class Availability3 implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Availability_3';
    ...
    /**
     * Sets available
     * @param string $available Whether the membership is available in the course. If the membership is not available, the associated user is considered inactive in the course.
     * @return $this
     */
