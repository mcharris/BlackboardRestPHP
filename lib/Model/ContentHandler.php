...
/**
 * ContentHandler Class Doc Comment
 *
 * @category    Class
 * @package     BlackboardRest
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ContentHandler implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ContentHandler';
    ...
    /**
     * Sets id
     * @param string $id The content handler's ID.  Publicly supported handlers:    | ID                           | Documentation         |  |------------------------------|-----------------------|  | resource/x-bb-courselink     | CourseLinkTOPubV1     |  | resource/x-bb-forumlink      | DiscussionLinkTOPubV1 |  | resource/x-bb-document       | ContentItemTOPubV1    |  | resource/x-bb-externallink   | ExternalLinkTOPubV1   |  | resource/x-bb-folder         | ContentFolderTOPubV1  |    For handlers that are not publicly supported yet, their ID will be shown here, and updates to common content attributes are allowed, but extended handler-specific attributes will not be visible.
     * @return $this
     */
