...
class Membership implements ArrayAccess
{
    ...
    protected static $setters = [
        ...
        'child_course_id' => 'setChildCourseId',
    ...
    protected static $getters = [
        ...
        'child_course_id' => 'getChildCourseId',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['child_course_id'] = isset($data['child_course_id']) ? $data['child_course_id'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['child_course_id'] === null) {
            $invalid_properties[] = "'child_course_id' can't be null";
        }
    ...
    /**
     * Sets user_id
     * @param string $user_id The primary ID of the user.
     * @return $this
     */
    ...
    /**
     * Sets course_id
     * @param string $course_id The primary ID of the course.
     * @return $this
     */
    ...
    /**
     * Gets child_course_id
     * @return string
     */
    public function getChildCourseId()
    {
        return $this->container['child_course_id'];
    }

    /**
     * Sets child_course_id
     * @param string $child_course_id The primary ID of the child, cross-listed course, in which the user is directly enrolled.  **Since**: 3000.11.0
     * @return $this
     */
    public function setChildCourseId($child_course_id)
    {
        $this->container['child_course_id'] = $child_course_id;
    ...
    /**
     * Sets created
     * @param \DateTime $created The date this membership was created.
     * @return $this
     */
