...
/**
 * ContentGroup Class Doc Comment
 *
 * @category    Class
 * @package     BlackboardRest
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ContentGroup implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ContentGroup';
    ...
    /**
     * Sets content_id
     * @param string $content_id The ID of the associated content.
     * @return $this
     */
    ...
    /**
     * Sets group_id
     * @param string $group_id The ID of the association of content and group.
     * @return $this
     */
