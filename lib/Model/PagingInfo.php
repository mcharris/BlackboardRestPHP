...
class PagingInfo implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PagingInfo';
    ...
    /**
     * Sets next_page
     * @param string $next_page The URL to use to navigate to the next page of results.  This field may be omitted when there is no additional data available.
     * @return $this
     */
