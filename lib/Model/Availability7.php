...
/**
 * Availability7 Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class Availability7 implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Availability_7';
    ...
    const AVAILABLE_SIGNUP_ONLY = 'SignupOnly';
    ...
    public function listInvalidProperties()
    {
        ...
        $allowed_values = ["Yes", "No", "SignupOnly"];
        if (!in_array($this->container['available'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'available', must be one of 'Yes', 'No', 'SignupOnly'.";
        }
    ...
    /**
     * Sets available
     * @param string $available Whether the Group is currently available to students.
     * @return $this
     */
    public function setAvailable($available)
    {
        $allowed_values = array('Yes', 'No', 'SignupOnly');
        if (!is_null($available) && (!in_array($available, $allowed_values))) {
            throw new \InvalidArgumentException("Invalid value for 'available', must be one of 'Yes', 'No', 'SignupOnly'");
        }
