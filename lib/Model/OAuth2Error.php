 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class OAuth2Error implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'OAuth2Error';
    ...
    public function listInvalidProperties()
    {
        ...
        $allowed_values = ["invalid_request", "invalid_client", "invalid_grant", "unauthorized_client", "unsupported_grant_type", "invalid_scope"];
        if (!in_array($this->container['error'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'error', must be one of 'invalid_request', 'invalid_client', 'invalid_grant', 'unauthorized_client', 'unsupported_grant_type', 'invalid_scope'.";
        }
    ...
    /**
     * Sets error
     * @param string $error Error code indicating high level source of error
     * @return $this
     */
    public function setError($error)
    {
        $allowed_values = array('invalid_request', 'invalid_client', 'invalid_grant', 'unauthorized_client', 'unsupported_grant_type', 'invalid_scope');
        if (!is_null($error) && (!in_array($error, $allowed_values))) {
            throw new \InvalidArgumentException("Invalid value for 'error', must be one of 'invalid_request', 'invalid_client', 'invalid_grant', 'unauthorized_client', 'unsupported_grant_type', 'invalid_scope'");
        }
     ...
     * @param string $error_description Optional text providing additional information about the error condition.
     * @return $this
     */
